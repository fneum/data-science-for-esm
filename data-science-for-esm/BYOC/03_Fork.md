...
> **Note:** The remote `gh-pages`, itself, hosts the required `.html`, `.css`, `.js`, and the other files, used for generating the `https://<user>.github.io/<myonlinebook>/` website. There is no requirement in having this branch locally.

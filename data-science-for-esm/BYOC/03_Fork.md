...
> **Note:** The remote `gh-pages`, itself, hosts the required `.html`, `.css`, `.js`, and the other files, used for generating the `https://github.com/<user>/data-science-for-esm` website. There is no requirement in having this branch locally.

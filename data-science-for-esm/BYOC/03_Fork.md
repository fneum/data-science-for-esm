...
> **Note:** The remote `gh-pages`, itself, hosts the required `.html`, `.css`, `.js`, and the other files, used for generating the `https://github.com/<user>/data-science-for-esm` website. <br /> <u>There is no requirement of having this branch locally.</u>
